...
# Función para realizar DFS en tiempo real
def dfs_real_time(graph, start, goal):
    visited = set()
    stack = [(start, [start])]
...
# Ejecutar DFS en tiempo real
start_time = time.time()
path, iterations = dfs_real_time(laberinto, start_node, goal_node)
end_time = time.time()
