...
# Función para realizar A* con heurística de Distancia Euclidiana
def astar_search_euclidean(labyrinth, start, goal):
...
# Ejecutar A* con heurística de Distancia Euclidiana
start_time = time.time()
path, iterations = astar_search_euclidean(laberinto, start_node, goal_node)
end_time = time.time()
