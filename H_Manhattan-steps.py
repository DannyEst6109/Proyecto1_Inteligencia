...
# Función para realizar A* con heurística de Distancia Manhattan en tiempo real
def astar_search_manhattan_real_time(labyrinth, start, goal):
...
# Ejecutar A* con heurística de Distancia Manhattan en tiempo real
start_time = time.time()
path, iterations = astar_search_manhattan_real_time(laberinto, start_node, goal_node)
end_time = time.time()
